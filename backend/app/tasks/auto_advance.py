"""
app/tasks/auto_advance.py — Block 2 V3.2
Background engine: auto-completes overdue in_progress steps.

Logic:
  Every 15 minutes, find steps where:
    status = 'in_progress'
    AND started_at + (duration_minutes * 1.5) < now()
  → mark complete, unlock next step, log alert
"""
