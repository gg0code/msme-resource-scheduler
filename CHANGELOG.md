...
### Migration
- `032 → 033` — `add_push_columns_to_tenants`. Three nullable columns on `tenants`. Run `alembic upgrade head` to apply; `alembic downgrade -1` reverts cleanly. Migrations 034+ remain owned by later v6.3.19 slices.
